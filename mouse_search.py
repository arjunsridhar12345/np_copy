...
root_pathlist = [
    ...
    PureWindowsPath(r"\\allen\programs\braintv\production"),
    PureWindowsPath(r"\\allen\programs\mindscope\workgroups\np-exp"),
    PureWindowsPath(r"\\10.128.50.43\sd6.3"), 
    PureWindowsPath(r"\\10.128.50.20\sd7"), 
    PureWindowsPath(r"\\10.128.50.20\sd7.2"), 
    PureWindowsPath(r"\\10.128.54.20\sd8"), 
    PureWindowsPath(r"\\10.128.54.20\sd8.2"), 
    PureWindowsPath(r"\\10.128.54.20\sd8.3"),
    PureWindowsPath(r"\\10.128.54.19\sd9"),
]
